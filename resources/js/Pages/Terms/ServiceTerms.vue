        ...
        <div class="w-full p-4">
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="">
                    ...
                    <br>
                    <p>3.1. A {{ state.platformName() }} reserva-se o direito de verificar a identidade do usuário antes de processar qualquer transação financeira. Isso pode incluir, mas não está limitado a, solicitar documentos de identificação e comprovantes de residência.</p>
                    <p>3.2. A {{ state.platformName() }} se reserva o direito de impor limites de saque a seu critério. Esses limites podem ser alterados a qualquer momento e sem aviso prévio.</p>
                    <p>3.3. A {{ state.platformName() }} não é responsável por quaisquer taxas ou encargos que possam ser cobrados pelo seu banco ou provedor de serviços financeiros.</p>
                    ...
                    <p>15.2. Estes Termos, juntamente com a Política de Privacidade e quaisquer outros acordos legais publicados no Site, constituem o acordo integral entre você e a {{ state.platformName() }} em relação ao uso do Site e dos Serviços.</p>
                    <p>15.3. Qualquer falha da {{ state.platformName() }} em exercer ou impor qualquer direito ou disposição destes Termos não será considerada uma renúncia a tal direito ou disposição.</p>
                    <br>
                    <h4 class="text-2xl">16. Política de Jogo Responsável</h4>
                    <br>
                    <p>16.1. A {{ state.platformName() }} está comprometida em fornecer um ambiente de jogo seguro e responsável. Encorajamos todos os nossos jogadores a jogar de forma responsável e a reconhecer que o jogo é uma forma de entretenimento e não deve ser usado como meio de ganhar dinheiro.</p>
                    ...
                    <br>
                    <p>17.1. A {{ state.platformName() }} oferece uma política de autoexclusão para aqueles que acreditam que podem ter um problema de jogo. Se você optar por se autoexcluir, sua conta será fechada e você não poderá acessar o site por um período de tempo especificado.</p>
                    <br>
                    <h4 class="text-2xl">18. Política de Reembolso</h4>
                    <br>
                    <p>18.1. A {{ state.platformName() }} não oferece reembolsos, exceto em circunstâncias excepcionais. Qualquer pedido de reembolso será avaliado caso a caso.</p>
                    <br>
                    ...
                    <br>
                    <p>20.1. A {{ state.platformName() }} leva a verificação de idade muito a sério. Qualquer usuário suspeito de ser menor de idade será solicitado a fornecer prova de idade. A falha em fornecer tal prova resultará no fechamento da conta do usuário.</p>
                    <br>
                    <h4 class="text-2xl">21. Política de Jogo Justo</h4>
                    <br>
                    <p>21.1. A {{ state.platformName() }} está comprometida em fornecer um ambiente de jogo justo para todos os seus usuários. Qualquer usuário encontrado manipulando o sistema de qualquer maneira será banido permanentemente do site.</p>
                </div>
            </div>
        </div>
